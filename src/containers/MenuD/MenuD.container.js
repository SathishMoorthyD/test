        ...
        <div class="card-body">
            <div class="row align-items-start">
               <div class="row gx-5">
                  <div class="col-6" >                   
                      <div class="p-2">
                        <TextField  value={values?.field_1} id={properties.field_1}   label= {properties.field_1}  size="small"  disabled={disabled}  fullWidth onChange={(e)=> handleChange(e.target.value,'field_1')} />  </div>
            ...
            <div class="row align-items-start">
               <div class="row gx-5">              
                  <div class="col-6">
                    ...
                    variant='outlined'
                    select
                    id={properties.field_35}
                    label={properties.field_35}
                    renderValue={(value) => (value !== undefined ? value : 'Approval Status')}
                    sx={{ maxHeight:30, textAlign:"left"}}
                    value={values?.field_35} disabled={statusdisabled}  onChange={(e)=>handleChange(e.target.value,'field_35')}
                    size="small"
                    >
